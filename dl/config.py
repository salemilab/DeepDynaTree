...
def get_arguments():
    ...
    data.add_argument("--batch_size", type=int, default=32, help="batch size for the graph training")
    ...
    model.add_argument("--model", type=str, default="tabnet",
    ...
    train.add_argument('--lr_decay_step_or_patience', type=int, default=300,
    ...
    train.add_argument('--early_stopping', default=200, help='The early stopping step.')
